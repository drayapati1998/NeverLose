...
const WelcomeState = ({ username = "{UserName}", onCreateClick }) => (
  <Container
    className="d-flex align-items-center justify-content-center"
    style={{ minHeight: "100%" }}
  >
    <div className="text-center py-5 px-4 bg-white rounded-4 shadow-sm w-100">
      <h1 className="fw-bold text-nl-dark mb-2">Hello, {username}!</h1>
      ...
      <div className="d-flex justify-content-center gap-1 mb-5 flex-wrap">
        ...
        <div className="text-center p-2" style={{ flex: "1 1 150px" }}>
          ...
          {/* <img
            ...
            className="me-2"
          /> */}
          <p className="small text-muted">Attach it and enjoy peace of mind</p>
        </div>
      </div>

      <CustomButton onClick={onCreateClick} variant="primary" className="px-5">
        Add New Item +
      </CustomButton>
    </div>
  </Container>
